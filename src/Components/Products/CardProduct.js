...
const CardProduct = ({ product, getProducts, client }) => {
  ...
  const handleadd1 = () => {
    ...
    axios
      .put(`${url}/api/catalog-products/${iid}/`, {
        // method: 'PUT',
        body: body,
      })
      .then((res) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap' }}>
      {product.length === 0 && (
        <h3 style={{ marginLeft: '300px' }} className="m-5 text-center">
          <b style={{ marginLeft: '530px', marginTop: '70px' }}>No Catalog</b>
        </h3>
      )}
          ...
          <div className="d-flex">
            ...
            <div>
              <div style={{ marginTop: '10px', marginBottom: '10px' }}>
                {produc.product.name && produc.product.name}
              </div>
              <div style={{}}>
                  ...
                  <div>
                    ...
                    {op !== pro.id && (
                      <div>
                        ...
                        >
                          <b style={{ fontWeight: '490', width: '138px' }}>
                            Price ({pro.from_quantity}-{pro.to_quantity})
                          </b>
                          <b
                            style={{
                              marginLeft: '0px',
                      ...
                      <div>
                        <Row style={{ marginTop: '10px' }}>
                          ...
                          <input
                            ...
                            name="price"
                            value={priceed}
                            onChange={(event) => setPriceed(event.target.value)}
                            placeholder="price"
                          ></input>
                          <SaveIcon
                            onClick={() => sendData()}
